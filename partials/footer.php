<div class='pt-1 footer-div'>
    <div class='container-fluid d-flex m-0 h-100 mb-5 pt-5 pb-5'>
        ...
        <div
            class='container col-3 h-100 border-2 border-end border-primary d-flex justify-content-around flex-column'>
            <h4 class='text-center display-5'>About Us</h4>
        ...
        <div
            class='container col-3 h-100 border-2 border-end border-primary d-flex justify-content-around flex-column'>
            <h4 class='text-center display-5'>Help</h4>
        ...
        <div
            ...
            <h4 class='text-center display-5'>Contact</h4>
            <p class='flex-grow-1 text-center'>Lorem ipsum dolor sit amet.</p>
        </div>
    </div>
</div>